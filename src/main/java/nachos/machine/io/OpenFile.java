...
public class OpenFile {
     ...
     *
     * @param pos value of the current file pointer to set
     */
    public void seek(int pos) {
    }

    /**
     * Get the value of the current file pointer.
     *
     * @return value of the current file pointer, or -1 if this file has no
     * pointer
     */
    public int tell() {
        return -1;
