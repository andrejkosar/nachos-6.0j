...
public class Packet {
     ...
     * </p>
     * <table>
     * <caption>Link-layer packet header format</caption>
     ...
     * @throws MalformedPacketException thrown when packet header parameters are not valid.
     */
