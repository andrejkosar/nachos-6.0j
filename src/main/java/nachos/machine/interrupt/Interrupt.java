...
package nachos.machine.interrupt;
 ...
 * </p>
 * <ul>
 * <li>interrupts are enabled, when they were previously disabled</li>
 * <li>a MIPS instruction is executed</li>
 * </ul>
 * <p>
...
public final class Interrupt {
    ...
    /**
     * @see Privilege.InterruptPrivilege#schedule(long, String, Runnable)
     */
    ...
    /**
     * @see Privilege.InterruptPrivilege#tick(boolean)
     */
    ...
    private class PendingInterrupt implements Comparable {
        ...
        public int compareTo(Object o) {
            ...
            int result = Long.compare(time, toOccur.time);
            if ( result == 0 ) {
                return Long.compare(id, toOccur.id);
            }
            return result;
        }
    }
    ...
    /**
     * @see Privilege.InterruptPrivilege
     */
